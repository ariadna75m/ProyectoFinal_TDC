...
ForpassImg = PhotoImage(file = "Library_Management_Sys/loginBg1.png")
ForpassImg = ForpassImg.subsample(2,2)

ForXieImg = PhotoImage(file='Library_Management_Sys/xielogoblack.png')
ForXieImg = ForXieImg.subsample(10,10)

Xieimg = PhotoImage(file='Library_Management_Sys/xielogoblack.png')
Xieimg = Xieimg.subsample(4,4)

logoimg = PhotoImage(file='Library_Management_Sys/LoginIcon.png')
logoimg = logoimg.subsample(3, 3)

usernameimg = PhotoImage(file='Library_Management_Sys/User.png')
usernameimg = usernameimg.subsample(1, 1)

passwordimg = PhotoImage(file='Library_Management_Sys/pass.png')
passwordimg = passwordimg.subsample(1, 1)

calanderimg = PhotoImage(file='Library_Management_Sys/Calendar.png')
calanderimg = calanderimg.subsample(1,1)

clockimg = PhotoImage(file='Library_Management_Sys/Clock.png')
clockimg = clockimg.subsample(1,1)

libraryimg = PhotoImage(file='Library_Management_Sys/bookBackImg.png')
libraryimg = libraryimg.subsample(1,1)

addbookimg = PhotoImage(file='Library_Management_Sys/addbookicon1.png')
addbookimg = addbookimg.subsample(6, 6)

issuebookimg = PhotoImage(file='Library_Management_Sys/issuebookicon1.png')
issuebookimg = issuebookimg.subsample(13, 12)

editbookimg = PhotoImage(file='Library_Management_Sys/editbookicon.png')
editbookimg = editbookimg.subsample(6, 6)

returnbookimg = PhotoImage(file='Library_Management_Sys/returnbookicon.png')
returnbookimg = returnbookimg.subsample(3, 3)

deletebookimg = PhotoImage(file='Library_Management_Sys/deletebookicon.png')
deletebookimg = deletebookimg.subsample(5, 5)

showbookimg = PhotoImage(file='Library_Management_Sys/showbookicon1.png')
showbookimg = showbookimg.subsample(1,1)

AddStudimg = PhotoImage(file='Library_Management_Sys/addStd.png')
AddStudimg = AddStudimg.subsample(2,2)

logoutimg = PhotoImage(file='Library_Management_Sys/logouticon.png')
logoutimg = logoutimg.subsample(1,1)

backbtnimg = PhotoImage(file='Library_Management_Sys/backbtnimg1.png')
backbtnimg = backbtnimg.subsample(5,6)

## Images in other Frames Backgrounds

addbookbg =PhotoImage(file = 'Library_Management_Sys/AddbookFrameBg.png')
addbookbg = addbookbg.subsample(2,3)

Issuebookbg =PhotoImage(file = 'Library_Management_Sys/IssueBookFrameBg.png')
Issuebookbg = Issuebookbg.subsample(1,1)

Editbookbg =PhotoImage(file = 'Library_Management_Sys/EditBookFrameBg.png')
Editbookbg = Editbookbg.subsample(2,3)

showbookbg =PhotoImage(file = 'Library_Management_Sys/showBookFrameBg.png')
showbookbg = showbookbg.subsample(1,1)

returnbookbg =PhotoImage(file = 'Library_Management_Sys/ReturnBookFrameBg.png')
returnbookbg = returnbookbg.subsample(2,2)

deletebookbg =PhotoImage(file = 'Library_Management_Sys/DeleteBookFrameBg.png')
deletebookbg = deletebookbg.subsample(2,3)

addStudbg =PhotoImage(file = 'Library_Management_Sys/AddStudentFrameBg.png')
addStudbg = addStudbg.subsample(1,1)

# Label Widget Icons
Idimg =PhotoImage(file = 'Library_Management_Sys/IDbook.png')
Idimg = Idimg.subsample(18,18)

Tilt = PhotoImage(file = 'Library_Management_Sys/TitleBook.png')
Tilt = Tilt.subsample(3,3)

Auth = PhotoImage(file = 'Library_Management_Sys/AuthorBook.png')
Auth = Auth.subsample(13,13)

edition = PhotoImage(file = 'Library_Management_Sys/editionBook.png')
edition = edition.subsample(17,17)

price = PhotoImage(file = 'Library_Management_Sys/priceBook.png')
price = price.subsample(1,1)

stdId = PhotoImage(file = 'Library_Management_Sys/StudentID.png')
stdId = stdId.subsample(1,1)

stdnamimg = PhotoImage(file = 'Library_Management_Sys/StdNamImg.png')
stdnamimg = stdnamimg.subsample(1,1)

stdcourseimg = PhotoImage(file = 'Library_Management_Sys/StdCoursImg.png')
stdcourseimg = stdcourseimg.subsample(1,1)

stdcontactimg = PhotoImage(file = 'Library_Management_Sys/StdphnImg.png')
stdcontactimg = stdcontactimg.subsample(1,1)

stdcollegeimg = PhotoImage(file = 'Library_Management_Sys/StdClgImg.png')
...
def loginbtnfunc():
    ...
    if user == "" or passw == "":
        ...
        try:
            ...
            t = mycursor.execute(query, (user, passw)).fetchone()
